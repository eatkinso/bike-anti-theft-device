/**
  ...
  *          for the services used by the bootloader (crypto operations for the Firmware and Metadata).
  ******************************************************************************
  * @attention
  *
...
/**
  ...
  *                           Authenticate Firmware Image using SHA256 on clear Firmware (SHA256 stored in the
...
/* Selected Crypto Scheme for bootloader operations */
